                ...
                <div className="flex items-center w-full max-w-md px-6 mx-auto lg:w-2/6">
                    <div className="flex-1">
                        ...
                        <div className="mt-8">
                            <form>
                                ...
                                <div className="mt-6">
                                    <div className="flex justify-between mb-2">
                                        ...
                                        <CustomLink to="/forgotpass" className="text-sm text-gray-400 focus:text-blue-500 hover:text-blue-500 hover:underline">Forgot password?</CustomLink>
                                    </div>
                                ...
                                <div className="mt-6">
                                    <a href="/emailverification" className="items-center justify-center flex w-full px-4 py-2 tracking-wide text-white transition-colors duration-300 transform bg-blue-500 rounded-lg hover:bg-blue-400 focus:outline-none focus:bg-blue-400 focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                                        Sign in
                                    </a>
                                </div>
                            </form>
                            ...
                            <button className="w-full p-2 mb-4 bg-blue-900 rounded text-white flex items-center justify-center">
