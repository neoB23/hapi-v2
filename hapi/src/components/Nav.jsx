        ...
        <div className="flex items-center justify-between">
          ...
          {/* Account Login Button */}
            <div className="relative hidden md:justify-center md:items-center md:inline-flex group">
                ...
                <CustomLink href="/login" className="relative inline-flex items-center justify-center px-6 py-2 text-base font-normal text-white bg-black border border-transparent rounded-full">
                  Account Login
                </CustomLink>
            </div>
        </div>
